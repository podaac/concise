...
Thank you for contributing to Concise!
...
The easiest way to get help or ask a question regarding Concise is in 
the EOSDIS Slack #podaac channel, or by asking a question 
...
of Concise that produced this bug and specific error messages.
...
Concise maintains a [changelog](CHANGELOG.md). See 
...
Concise follows PEP8 as much as possible. Reference the [pylint](.pylintrc) and 
...
Please keep any Harmony or CMR-specific code out of the actual Concise 
code. The Concise service should be able to run locally without any reliance 
on outside services.

### Documentation

Concise uses [Numpy docstrings](https://numpydoc.readthedocs.io/en/latest/format.html). 
